		...
		<div>
			<div>
				...
				<fieldset class="form-group">
					...
					<select value='${bill.type}' name="type" class="form-control" id="mySelect" onchange="payment()" required="required">
						<option></option>
				...
				<fieldset class="form-group">
					<label>Ngày trả tiền</label> <input type="date"
				...
				<fieldset class="form-group">
					<label>Tên tổ chức</label> 
						<select name="tblAssociationid" class="form-control" > 
				...
				<tbody id="BHYT1">
					...
					<c:forEach var="bhyt"  items="${bhytList}" varStatus="loop">
						...
						<tr id="salary-${loop.index}">
							...
							<td> <a href="Bhyt-delete?id=<c:out value='${bhyt.id}' />">Delete</a></td>
						</tr>
